#!/bin/bash
#SBATCH --job-name=downstream_4a_v0
#SBATCH --output=logs_summarized/downstream_eval/model_4a_v0/model_4a_v0_%j.out
#SBATCH --error=logs_summarized/downstream_eval/model_4a_v0/model_4a_v0_%j.err
...
CONFIG_FILE="configs_summarized/downstream_eval/model_4a_balanced_pretrain_v0.yaml"
...
echo "=========================================="
echo "Starting downstream classifier training (Model 4a v0)..."
...
CHECKPOINT_PATH_1="outputs/downstream_eval/model_4a_v0_finetune/checkpoint_best.pth"
CHECKPOINT_PATH_2="outputs_summarized/downstream_eval/model_4a_v0_finetune/checkpoint_best.pth"

if [ -f "$CHECKPOINT_PATH_1" ] || [ -f "$CHECKPOINT_PATH_2" ]; then
    echo "Checkpoint found for model_4a_v0_finetune. Skipping training, running evaluation only..."
    ...
    echo "No checkpoint found for model_4a_v0_finetune, starting training..."
    python scripts/train_downstream_classifier.py \
        --config "$CONFIG_FILE" \
        --n_bootstrap 1000 \
        --random_seed 42
