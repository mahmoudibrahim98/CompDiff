#!/bin/bash
#SBATCH --job-name=downstream_3b_fd
#SBATCH --output=logs_summarized/downstream_eval/model_3b_fairdiffusion/model_3b_fairdiffusion_%j.out
#SBATCH --error=logs_summarized/downstream_eval/model_3b_fairdiffusion/model_3b_fairdiffusion_%j.err
...
mkdir -p logs_summarized/downstream_eval/model_3b_fairdiffusion

CONFIG_FILE="configs_summarized/downstream_eval/model_3b_fairdiffusion.yaml"
if [ ! -f "$CONFIG_FILE" ]; then
    echo "ERROR: Config file not found: $CONFIG_FILE"
    exit 1
fi

echo "Starting downstream classifier training (Model 3b FairDiffusion)..."
CHECKPOINT_PATH_1="outputs_summarized/downstream_eval/model_3b_fairdiffusion_finetune_1.0/checkpoint_best.pth"
CHECKPOINT_PATH_2="outputs/downstream_eval/model_3b_fairdiffusion_finetune_1.0/checkpoint_best.pth"
