#!/bin/bash
#SBATCH --job-name=downstream_1b_v7
#SBATCH --output=logs_summarized/downstream_eval/model_1b_v7/model_1b_v7_%j.out
#SBATCH --error=logs_summarized/downstream_eval/model_1b_v7/model_1b_v7_%j.err
...
# Config file path
CONFIG_FILE="configs_summarized/downstream_eval/model_1b_real_synthetic_1x_v7.yaml"
...
# Launch training
echo "=========================================="
echo "Starting downstream classifier training (Model 1b v7)..."
echo "Config file: $CONFIG_FILE"
echo "=========================================="

# Check if checkpoint exists - if yes, skip training and only evaluate
# Check both possible output directory locations
CHECKPOINT_PATH=""
CHECKPOINT_PATH1="outputs_summarized/downstream_eval/model_1b_v7/checkpoint_best.pth"
CHECKPOINT_PATH2="outputs_summarized/downstream_eval/model_1b_v7/checkpoint_best.pth"
