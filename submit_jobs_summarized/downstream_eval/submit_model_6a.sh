#!/bin/bash
#SBATCH --job-name=downstream_6a
#SBATCH --output=logs_summarized/downstream_eval/model_6a/model_6a_%j.out
#SBATCH --error=logs_summarized/downstream_eval/model_6a/model_6a_%j.err
...
# Config file path
CONFIG_FILE="configs_summarized/downstream_eval/model_6a.yaml"
...
# Launch training
echo "=========================================="
echo "Starting downstream classifier training (Model 6a)..."
echo "Config file: $CONFIG_FILE"
echo "Strategy 6a: Train on real_data_summarized_four_splits/training_data"
echo "             Validate on real_data_summarized_four_splits/val_data"
echo "             Test on: test_data, GT_data, synthetic v0, synthetic v7"
echo "=========================================="

# Check if checkpoint exists - if yes, skip training and only evaluate
CHECKPOINT_PATH="outputs_summarized/downstream_eval/model_6a/checkpoint_best.pth"
