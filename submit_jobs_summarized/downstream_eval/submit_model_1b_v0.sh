#!/bin/bash
#SBATCH --job-name=downstream_1b_v0
#SBATCH --output=logs_summarized/downstream_eval/model_1b_v0/model_1b_v0_%j.out
#SBATCH --error=logs_summarized/downstream_eval/model_1b_v0/model_1b_v0_%j.err
...
# Config file path
CONFIG_FILE="configs_summarized/downstream_eval/model_1b_real_synthetic_1x_v0.yaml"
...
# Launch training
echo "=========================================="
echo "Starting downstream classifier training (Model 1b v0)..."
...
CHECKPOINT_PATH=""
CHECKPOINT_PATH1="outputs_summarized/downstream_eval/model_1b_v0/checkpoint_best.pth"
CHECKPOINT_PATH2="outputs/downstream_eval/model_1b_v0/checkpoint_best.pth"
