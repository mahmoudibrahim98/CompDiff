...
#SBATCH --output=logs_summarized/logs_fairdiffusion/1_train_hcn_fairdiffusion/validation_%j.out
#SBATCH --error=logs_summarized/logs_fairdiffusion/1_train_hcn_fairdiffusion/validation_%j.err
...
CONFIG_FILE="${1:-configs_summarized/fairdiffusion/1_train_hcn_fairdiffusion.yaml}"  # Use first argument or default
