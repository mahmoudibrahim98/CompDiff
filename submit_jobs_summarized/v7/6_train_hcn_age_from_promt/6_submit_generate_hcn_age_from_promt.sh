...
#SBATCH --output=logs_summarized/logs_v7/6_train_hcn_age_from_promt/generate_synthetic_%j.out
#SBATCH --error=logs_summarized/logs_v7/6_train_hcn_age_from_promt/generate_synthetic_%j.err
...
#SBATCH --mem=230gb                # Memory for generation (8 processes × models)
...
#
# Arguments:
#   checkpoint_path (optional): Path to checkpoint directory (default: outputs_summarized/v7/6_train_hcn_age_from_promt/CHECKPOINT)
...
DEFAULT_OUTPUT_DIR="synthetic_datasets/v7/6_train_hcn_age_from_promt/train-20000-copy3"
