...
#SBATCH --output=logs_summarized/logs_v7/6_train_hcn_age_from_promt/training_%j.out
#SBATCH --error=logs_summarized/logs_v7/6_train_hcn_age_from_promt/training_%j.err
