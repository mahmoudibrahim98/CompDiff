...
#SBATCH --output=logs_summarized/logs_v0/0_train_baseline/validation_%j.out
#SBATCH --error=logs_summarized/logs_v0/0_train_baseline/validation_%j.err
...
CONFIG_FILE="${1:-configs_summarized/v0/0_train_baseline.yaml}"  # Use first argument or default
