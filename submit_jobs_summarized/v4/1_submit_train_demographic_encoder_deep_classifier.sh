...
#SBATCH --output=logs_summarized/logs_v4/1_train_demographic_encoder_deep_classifier/training_%j.out
#SBATCH --error=logs_summarized/logs_v4/1_train_demographic_encoder_deep_classifier/training_%j.err
...
mkdir -p logs_summarized/logs_v4/1_train_demographic_encoder_deep_classifier

# Config file path (adjust as needed)
CONFIG_FILE="configs_summarized/v4/1_train_demographic_encoder_deep_classifier.yaml"
