...
#SBATCH --output=logs_summarized/logs_v4/1_train_demographic_encoder_deep_classifier/validation_%j.out
#SBATCH --error=logs_summarized/logs_v4/1_train_demographic_encoder_deep_classifier/validation_%j.err
...
CONFIG_FILE="${1:-configs_summarized/v4/1_train_demographic_encoder_deep_classifier.yaml}"  # Use first argument or default
