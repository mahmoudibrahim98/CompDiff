...
#SBATCH --output=logs_summarized/logs_v4/0_train_demographic_encoder/training_%j.out
#SBATCH --error=logs_summarized/logs_v4/0_train_demographic_encoder/training_%j.err
...
mkdir -p logs_summarized/logs_v4/0_train_demographic_encoder

# Config file path (adjust as needed)
CONFIG_FILE="configs_summarized/v4/0_train_demographic_encoder.yaml"
