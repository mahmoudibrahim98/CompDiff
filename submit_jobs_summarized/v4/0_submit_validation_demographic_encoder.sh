...
#SBATCH --output=logs_summarized/logs_v4/0_train_demographic_encoder/validation_%j.out
#SBATCH --error=logs_summarized/logs_v4/0_train_demographic_encoder/validation_%j.err
...
CONFIG_FILE="${1:-configs_summarized/v4/0_train_demographic_encoder.yaml}"  # Use first argument or default
